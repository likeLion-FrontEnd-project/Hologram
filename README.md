...
**❓ Vanilla JS를 사용한 이유** 
- 프로젝트에서 주어진 기간 내 완성하는 것이 가장 최우선 목표였습니다. Vanilla JS를 사용해 빠르게 구현하여 기능의 99% 완성하였습니다.
- 다른 이유로는 리빌딩 경험도 해보고 싶어 추후 React로 진행할 예정입니다.
...
- 기간 내에 Vanilla JS에서 React 리빌딩까지 하고 싶었으나 기능 구현에서 시간이 걸려 Vanilla JS로만 구현하였습니다.
