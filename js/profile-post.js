...
const accountMe = localStorage.getItem('accountname');
...
const modalReportCenter = document.querySelector('.modal-window-center-report');
const modalCancelBtn = document.querySelectorAll('#cancel-btn');
const modalDeleteBtn = document.querySelector('#delete-btn');
const modalPostCancelBtn = document.querySelector('#cancel-post-btn');
