...
const modalPostReportCenter = document.querySelector(
  '.modal-window-center-post-report'
);
const modalCommentReportCenter = document.querySelector(
  '.modal-window-center-report'
);
